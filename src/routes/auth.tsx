    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6">
      <div className="w-full max-w-md border border-border bg-[var(--navy-mid)] p-8">
        ...
        <button
          ...
          disabled={busy}
          className="w-full flex items-center justify-center gap-2 border border-border bg-background px-4 py-3 text-sm tracking-wider hover:bg-secondary transition-colors disabled:opacity-50 mb-6"
        >
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-[10px] tracking-widest text-muted-foreground">ИЛИ</span>
          <div className="flex-1 h-px bg-border" />
        </div>
