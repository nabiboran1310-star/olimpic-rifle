...
const CAREER_LEVELS: CareerLevel[] = [
  ...
  {
    id: 6, name: "Стабильная серия", short: "L6 · PRECISION",
    description: "Винтовка 10м. Десятые очки. 10 выстрелов. Цель: 102.0+.",
    disciplineId: "ar10", shots: 10, winScore: 102.0, scoring: "decimal", moving: false, hardcore: false,
  },
  {
    id: 7, name: "Кабан в темпе", short: "L7 · FAST BOAR",
    description: "Бегущая мишень. Нужно плавно вести цель без лишних движений вверх-вниз. 10 выстрелов. Цель: 102.5+.",
    disciplineId: "boar", shots: 10, winScore: 102.5, scoring: "decimal", moving: true, hardcore: true,
  },
  {
    id: 8, name: "Пистолет под давлением", short: "L8 · TRIGGER",
    description: "Пистолет 10м. Ошибка спуска сильнее уводит выстрел. 10 выстрелов. Цель: 103.0+.",
    disciplineId: "ap10", shots: 10, winScore: 103.0, scoring: "decimal", moving: false, hardcore: true,
  },
  {
    id: 9, name: "Ветер 50 метров", short: "L9 · HARD WIND",
    description: "Винтовка 50м. Дальняя дистанция и сильнее влияние ветра. 10 выстрелов. Цель: 104.5+.",
    disciplineId: "rifle50", shots: 10, winScore: 104.5, scoring: "decimal", moving: false, hardcore: true,
  },
  {
    id: 10, name: "Мастерская квалификация", short: "L10 · MASTER",
    description: "Скоростной пистолет 25м. Финальный отбор перед олимпийским финалом. 10 выстрелов. Цель: 105.0+.",
...
const UPGRADES: Upgrade[] = [
  ...
  { id: "stance", name: "Стойка мастера", desc: "Еще на 12% снижает базовое качание прицела в сложных сериях.", price: 7500 },
  { id: "trigger", name: "Мягкий спуск", desc: "Уменьшает случайный микрорывок при выстреле и помогает пистолетным дисциплинам.", price: 9000 },
  { id: "wind-reader", name: "Ветровой фильтр", desc: "Снижает влияние ветра на 50 м и поздних карьерных уровнях.", price: 11000 },
  { id: "fast-bolt", name: "Быстрый затвор", desc: "Перезарядка проходит быстрее, меньше пауз между выстрелами.", price: 6500 },
  { id: "tracking", name: "Тренировка проводки", desc: "Бегущий кабан движется чуть спокойнее, легче вести мишень.", price: 8500 },
];
          ...
          >
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-[220px_1fr_190px] gap-5 md:gap-7 items-center p-6 md:p-8 min-h-[210px]">
              ...
              <div className={`shrink-0 text-center font-black tracking-widest px-5 py-5 text-xs md:text-sm ${
                ...
                {olympicUnlocked ? "ВЫЙТИ В ФИНАЛ" : `НУЖНО ${CAREER_LEVEL_COUNT}/${CAREER_LEVEL_COUNT}`}
              </div>
            </div>
          </button>
        </div>
